...
public interface AppointmentCreate extends AppointmentCommand {
    ...
    // When you call the implementation of this command, in this case RegisterAppointment
    ...
    // inside the RegisterAppointment record that implements this interface
    @HandleCommand
    ...
    default void assertExistence(@Nullable Appointment current) {
        ...
        if (current != null) {
            throw AppointmentErrors.alreadyExists;
        }
    }
